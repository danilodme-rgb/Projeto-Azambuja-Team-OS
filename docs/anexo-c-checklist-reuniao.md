...
retrabalho evitada depois. **Tempo estimado: 90 a 120 minutos.**
...
- [ ] O que ele quer ver no relatório que não está na lista da seção 6.2?
...
2. Preços e planos definidos
3. Situação de CREF/CRN esclarecida
4. Escopo do MVP congelado e assinado
5. Gateway de pagamento escolhido
6. Data-alvo de lançamento

Com esses seis pontos fechados, o desenvolvimento começa.
