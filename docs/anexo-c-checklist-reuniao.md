...
- [ ] Nome da marca e domínio (`.com.br`)
- [ ] Já existe logo e identidade visual? Se não, quem faz?
- [ ] Preço dos planos: mensal, trimestral, semestral, anual
- [ ] Política de cancelamento e reembolso
- [ ] Quantos alunos ele quer atender por mês? E qual o teto de atendimento dele?
- [ ] Gateway de pagamento preferido (Asaas / Mercado Pago / Pagar.me / Stripe)
...
- [ ] Se não: trabalha com nutricionista parceiro, ou atua com orientação alimentar dentro do
...
- [ ] Aceita alunos **menores de 18 anos**? (exige consentimento do responsável)
...
- [ ] Prazo prometido para responder a solicitação (sugestão: 2 dias úteis)
...
- [ ] **Montagem: do zero, por modelos, ou os dois?** *(recomendação: os dois)*
...
- [ ] **Técnicas avançadas: preencher o Anexo A** ⚠️
- [ ] Registra **RIR/RPE**? Ou é complexidade demais para o aluno?
...
- [ ] Vídeos: só links do YouTube (Leandro Twin) ou também vídeos gravados por ele?
...
- [ ] **A trava funciona?** Sistema impedir a publicação do treino até o contato prévio ser
      registrado — ou apenas alertar? *(recomendação: impedir, com dispensa justificada)*
- [ ] Como ele prefere fazer esse contato: videochamada, telefone ou áudio?
- [ ] **Prazos de revisão por gravidade** — validar ou substituir a tabela sugerida:
...
- [ ] Exigir isso em **todos** os exercícios, ou só nos que dependem de aparelho específico?
...
- [ ] **Inventário de equipamentos da academia do aluno** — entra no MVP ou fica para a Fase 2?
...
- [ ] Frequência de pesagem, medidas e fotos de acompanhamento
...
- [ ] Dias e horários fixos para as calls
...
- [ ] Por quanto tempo guardar fotos e dados após o fim do contrato (sugestão: 12 meses)
- [ ] Quem será o **Encarregado de dados (DPO)** e qual e-mail publicar
...
1. Anexo A preenchido (técnicas avançadas)
2. Prazos de revisão de lesão definidos por gravidade
3. Regra do titular + substitutos confirmada
4. Preços e planos definidos
5. Situação de CREF/CRN esclarecida
6. Escopo do MVP congelado e assinado
7. Gateway de pagamento escolhido
8. Data-alvo de lançamento

Com esses oito pontos fechados, o desenvolvimento começa.
